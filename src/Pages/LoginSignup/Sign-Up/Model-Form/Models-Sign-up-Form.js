...
function ModelSignUpForm() {
  ...
  return (
    <section
      style={{
        transform: activeSignup === "model" && toggleSignup && `translateX(${0}%)`,
      }}
      className="sign-up">
      <form className="model-sign-up" onSubmit={(e) => e.preventDefault()}>
        ...
        <section className="sign-up-section">
          <i onClick={() => setToggleSignup(false)} className="fa-solid fa-xmark close-sign-up"></i>
