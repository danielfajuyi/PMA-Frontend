...
import "./Client-Sign-up-Form.css";

function ClientSignUpForm({ createAccount, handleModal }) {
  // user data state
  ...
  return (
    <section className="--sign-up">
      <form className="client-sign-up" onSubmit={(e) => e.preventDefault()}>
        ...
        <section className="--sign-up-section">
          <i className="fa-solid fa-xmark --close-sign-up --colored-hover"></i>
          ...
          <div className="--input-sections">
            ...
            <div className="--other-container">
              ...
              <button
                ...
                onClick={() => {
                  isError ? handleModal("sign-up-Err") : sendForm();
                }}
