    ...
    <form className="content--container" onSubmit={(e) => e.preventDefault()}>
      ...
      <section className="set__sections-container">
        <div className="set__sections-title-rapper">
          <h2 className="set__sections-title">Reset Password</h2>
          <EditBtn
            btnText={
              activeEdit === "Reset"
                ? "Verify"
      ...
      <section className="set__sections-container">
        <div className="set__sections-title-rapper">
          <h2 className="set__sections-title">Update Email</h2>
          <EditBtn
            btnText={
              activeEdit === "Update"
                ? "Check"
      ...
      <section className="set__sections-container">
        <h2 className="set__sections-title">Account Deactivation</h2>
        <p className="set_note-text">
          <i className="fa-solid fa-angles-right points"></i>
